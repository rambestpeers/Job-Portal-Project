...
RSpec.describe Apply, type: :model do
  it "is valid with a name, skills, about_yourself, education, job_id, user_id" do
    ...
    job = Job.create(title: "Full Stack Developer", description: "This is a job", job_category: "Computer Science", location: "Indore", job_author: "Ram", job_company: "Tcs", salary: 4, user_id: user.id)
    apply = Apply.new(name: "Ram", skills: "Ruby,Rails", about_yourself: "My name is Ram", education: "MCA", job_id: job.id, user_id: job.user_id )
