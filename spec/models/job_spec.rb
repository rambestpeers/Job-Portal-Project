...
RSpec.describe Job, type: :model do
  it 'is valid with a title, description, job_category, location, job_author, job_company, salary, user_id' do
    user = User.create(role: true, name: 'John Doe1', email: 'johndoe1@example.com', password: 'ram123',
                       password_confirmation: 'ram123')
    job = Job.new(title: 'Full Stack Developer', description: 'This is a job', job_category: 'Computer Science',
  ...
  it 'is not valid with a title, description, job_category, location, job_author, job_company, salary' do
    User.create(role: true, name: 'John Doe2', email: 'johndoe2@example.com', password: 'ram123',
                password_confirmation: 'ram123')
    job = Job.new(title: 'Full Stack Developer', description: 'This is a job', job_category: 'Computer Science',
                  location: 'Indore', job_author: 'Ram', job_company: 'Tcs', salary: 4)
    expect(job).to_not be_valid
  end

  # it "is not valid with a title, description, user_id" do
  #   user = User.create(role: true, name: "John Doe3", email: "johndoe3@example.com", password: "ram123", password_confirmation: "ram123")
  #   job = Job.new(title: "", description: "", job_category: "", location: "", job_author: "", job_company: "", salary: 4, user_id: user.id)
  #   expect(job).to_not be_valid
  # end
