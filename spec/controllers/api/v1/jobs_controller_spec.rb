...
RSpec.describe Api::V1::JobsController, type: :controller do
  let(:user) do
    User.create(role: true, name: 'Shiva', email: 'shiva@example.com', password: 'john123',
  ...
  describe  'JobsController#create' do
    context 'recruiter can create job' do
      it 'create the job' do
        post :create,
             params: { job: { title: 'Civil Engineer 1', description: 'this is job', job_category: 'civil', location: 'Dehradhun',
                              job_author: 'Praveen', job_company: 'Techno', salary: 4 } }
