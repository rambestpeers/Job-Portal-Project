...
RSpec.describe Api::V1::SessionsController, type: :controller do
  let(:user) do
    User.create(role: true, name: 'John Doe', email: 'johndoe@example.com', password: 'john123',
  ...
  describe 'SessionsController#create' do
    context 'user can be created' do
      it 'create the user' do
        post :create,
             params: { user: { role: true, name: 'Rakesh', email: 'rakesh@example.com', password: 'rakesh123',
                               password_confirmation: 'rakesh123' } }
  ...
  describe 'SessionsController#login' do
    context 'user can login' do
      it 'login the user' do
        User.create(role: true, name: 'Rakesh', email: 'rakesh@example.com', password: 'rakesh123',
                    password_confirmation: 'rakesh123')
