...
RSpec.describe ApplyController, type: :controller do
  let(:user) { User.create(role: false, name: "John Doe", email: "johndoe@example.com", password:"john123", password_confirmation:"john123")}
  let(:recruiter) { User.create(role: true, name: "Ram Sharma", email: "ram@example.com", password:"john123", password_confirmation:"john123")}
